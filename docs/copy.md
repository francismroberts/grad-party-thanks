...
|---|---|---|
| Thank You — Francis Grad Party | index.html | Browser tab title and link-preview title |
| Thanks for coming. All the photos are here. And if you got video of the speech, send it to me. | index.html | Meta description and link-preview description (iMessage, WhatsApp) |
| Thank you | index.html | Small tracked label above the headline |
| I appreciate everyone who showed up to celebrate. | index.html | Headline (h1) |
| I got a Masters Degree, I threw a party, my community showed up. Should we run it back? | index.html | Lead, first paragraph, serif |
| Nah, I'm going to sit in this for a while. | index.html | Lead, second paragraph, with a beat of space before it |
| All the photos are here. Download them. Post them. And tag meeeee! | index.html | Body paragraph |
| Got video of the speech? Scroll down, I need it ↓ | index.html | Tracked uppercase link, anchors to the upload form |
| Photographer Pics | index.html | Caption band over the photographer card's cover photo |
| Photos | index.html | Small label under the photographer card, left |
| {n} photos | index.html (inline script) | Italic count under the photographer card, right; live from the database, e.g. "294 photos" |
| Photo Booth Pics | index.html | Caption band over the booth card's cover photo |
...
| *(upload form — see the Upload form section below; it appears here in full)* | assets/upload.js | Between the cards and the closing line |
| Thanks again for showing up! | index.html | Italic closing line at the very bottom |
...
| Every photo the booth took. Grab yours. | booth.html | Meta and link-preview description |
...
| Everything from the photo booth. | booth.html | Headline (h1); no lead line beneath |
| On your phone? Long press any photo to save it right to your camera roll. Grabbing a lot? Hit select and choose what you want to download. | booth.html | Italic tip above the gallery |
...
| Download all · {size} | booth.html + assets/gallery.js | Gallery header primary button; size read from the archive, e.g. "Download all · 35 MB". Shows "…" until known; whole block hidden if no archive |
| Full resolution, straight from the booth. Easier on a computer. | booth.html | Italic note under the Download all button |
...
| That's {size}. Grab the whole gallery instead, or pick fewer. | assets/gallery.js | Note under the bar when the selection passes 2 GB; "Grab the whole gallery instead" is a link to the Download all archive |
| That's {size}. Pick fewer photos. | assets/gallery.js | Same, when no archive is available to link to |
...
| Done · {size} | assets/gallery.js | Bar counter for about 2 s after the zip is saved |
| This browser can't handle a zip that big ({size}). Pick fewer photos, or use a computer. | assets/gallery.js | Note under the bar on browsers that can only buffer in memory, when the selection is over 150 MB |
...
| Every photo the photographer took. Grab yours. | photos.html | Meta and link-preview description |
| ← Thank you | photos.html | Tracked link at the top |
| Photos | photos.html | Small tracked label above the headline |
| The photographer's photos. | photos.html | Headline (h1); no lead line beneath |
| On your phone? Long press any photo to save it right to your camera roll. Grabbing a lot? Hit select and choose what you want to download. | photos.html | Italic tip above the gallery |
...
| Full resolution, straight from the camera. Easier on a computer. | photos.html | Italic note under the Download all button |
...
| Got video of the speech? | upload.html | Link-preview title (`og:title`), what people see when the link is texted |
| If you got a good video of the speech, send it to me here. | upload.html | Meta and link-preview description |
| ← Thank you | upload.html | Tracked link at the top |
| Upload | upload.html | Small tracked label above the headline |
| Send me what you got! | upload.html | Headline (h1) |
| Especially the speech. Whatever you caught, this is where it goes. | upload.html | Lead line |
...
| Got a *good* video of the speech? Send it over. | assets/upload.js | Form heading (h2); "good" is italic via `<em>` |
| Photos too. Anything from the day you think I'd want. Big files are fine. If your connection drops, it picks right back up where it left off. | assets/upload.js | Paragraph under the heading |
...
| I'm watching this tonight. Thank you, seriously. | assets/upload.js | Confirmation line when at least one upload was a video |
| I'll go through these this week and add the good ones to the galleries. | assets/upload.js | Confirmation line when the uploads were photos only |
| {n} of {total} made it. | assets/upload.js | Confirmation heading when some files failed, e.g. "3 of 5 made it." |
| Hit Retry on the one that didn't whenever you're ready. It picks up right where it stopped. | assets/upload.js | Confirmation line when exactly one file failed |
| Hit Retry on the ones that didn't whenever you're ready. They pick up right where they stopped. | assets/upload.js | Same, when more than one failed |
